...
type PeriodicAccountOut struct {
	...
	V33GiftsOfGrandCelebration       bool                         `json:"v33_gifts_of_grand_celebration"`
	V33GiftsOfGrandCelebrationStatus string                       `json:"v33_gifts_of_grand_celebration_status"`
	V33BountifulWaves                bool                         `json:"v33_bountiful_waves"`
	V33BountifulWavesStatus          string                       `json:"v33_bountiful_waves_status"`
	V33StarBouncing                  bool                         `json:"v33_star_bouncing"`
	V33StarBouncingStatus            string                       `json:"v33_star_bouncing_status"`
	V33CubieDerbyChampionship        bool                         `json:"v33_cubie_derby_championship"`
	V33CubieDerbyChampionshipStatus  string                       `json:"v33_cubie_derby_championship_status"`
