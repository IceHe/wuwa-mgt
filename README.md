...
CURRENT_FV_START=2026-07-10
CURRENT_HV_START=2026-07-10
```
...
- 当前默认版本为 `2026-07-10` 至 `2026-08-20`；进入二阶段后可将 `CURRENT_HV_START` 调整为 `2026-07-31`
